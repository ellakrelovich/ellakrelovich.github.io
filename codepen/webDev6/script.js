...
let audioContext;
const chordNotes = {
	I: [261.63, 329.63, 392.0], // C major (C-E-G)
	ii: [293.66, 349.23, 440.0], // D minor (D-F-A)
	iii: [329.63, 392.0, 493.88], // E minor (E-G-B)
	IV: [349.23, 440.0, 523.25], // F major (F-A-C)
	V: [392.0, 493.88, 587.33], // G major (G-B-D)
	vi: [440.0, 523.25, 659.25], // A minor (A-C-E)
	"vii°": [493.88, 587.33, 698.46] // B diminished (B-D-F)
};
